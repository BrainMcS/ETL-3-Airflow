...
The `project ID` is your GCP Project name (mine was the bproject ID generated by GCP). And finally the `service_account.json` the one that you saved in the `include/gcp/` folder.
